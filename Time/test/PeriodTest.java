...
public class PeriodTest {
    ...
    @Test
    void setBeginTimeTest(ITime beginTime){
    ...
    @Test
    void setEndTimeTest(ITime endTime){
    ...
    @Test
    void changeLengthWithTest(int minutes){
    ...
    @Test
    void intersectionWithTest(IPeriod p){
